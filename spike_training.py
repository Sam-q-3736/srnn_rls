...
class spike_training:
    ...
    def train_network(neuron_params, time_params, train_params, W, stim, targets):
        raise NotImplementedError

    def run_network(neuron_params, time_params, W, stim, run_time):
        raise NotImplementedError

    def plot_spk_rasts(spk_rast):
